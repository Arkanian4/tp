...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_ADDRESS_DESC,
                Address.getValidationMessage("1" + INVALID_ADDRESS_DESC));
        assertParseFailure(parser, "1" + INVALID_ORDER_DESCRIPTION_DESC, Remark.MESSAGE_INVALID_CHARACTERS);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // address
        assertParseSuccess(parser, targetIndex.getOneBased() + ADDRESS_DESC_AMY,
                new EditCommand(targetIndex,
                        new EditPersonDescriptorBuilder().withAddress(VALID_ADDRESS_AMY).build()));

        // remark
        assertParseSuccess(parser, targetIndex.getOneBased() + ORDER_DESCRIPTION_DESC_AMY,
                new EditCommand(targetIndex,
                        new EditPersonDescriptorBuilder().withRemark(VALID_ORDER_DESCRIPTION_AMY).build()));
